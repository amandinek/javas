      function dayNames(){
  var input =document.getElementById('bday').nodeValue;
  var DD,MM,YY;
  ...
  // DD=document.getElementById("bday").value; 
  // MM=document.getElementById("bday").value;
  // YY=document.getElementById("bday").value;
